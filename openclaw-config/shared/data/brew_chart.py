...
def connect_db():
    """Return a read-only MySQL connection to the Starbucks database."""
    cfg = {}
    cnf_path = os.path.join(os.path.dirname(__file__), "mysql-readonly.cnf")
    ...
    return pymysql.connect(
        ...
        database=cfg.get("database", "brewlytics"),
        charset=cfg.get("default-character-set", "utf8mb4"),
    )
